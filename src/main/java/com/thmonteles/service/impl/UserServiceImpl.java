...
import com.thmonteles.service.UserService;
import com.thmonteles.service.exception.NotFoundException;
...
public class UserServiceImpl implements UserService {
    ...
    public User create(User userToCreate) {
        ...
        if (userRepository.existsByEmail(userToCreate.getEmail())) {
            throw new BusinessException("This account email already exists.");
        }
